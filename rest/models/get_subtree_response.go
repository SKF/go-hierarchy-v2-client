...
func (m *GetSubtreeResponse) validateLinks(formats strfmt.Registry) error {
...
func (m *GetSubtreeResponse) validateNodes(formats strfmt.Registry) error {
